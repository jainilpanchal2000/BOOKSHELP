...
VALUES (1, 1, 2, 'hello', '2020-02-23 06:11:27', 0),
...
--
INSERT INTO `colleges` (`INST CODE`, `Institute Name`)
VALUES (
    '1',
...
--
INSERT INTO `contact_data` (`Msg_id`, `Name`, `Email`, `Subject`, `Message`)
VALUES (
    1,
    'Parth Narodia',
    'abc@xyz.com',
...
--
INSERT INTO `login` (`user_id`, `username`)
VALUES (3, 'bhavesh'),
  (15, 'marvin'),
  (16, 'jainil123'),
  (17, 'kaushal123');
...
VALUES (1, 1, '2020-02-23 07:19:53', 'no'),
  (2, 2, '2020-02-23 08:08:10', 'no'),
  (3, 6, '2020-06-04 10:05:06', 'no'),
  ...
  (73, 17, '2020-02-28 09:25:24', 'no'),
  (74, 15, '2020-02-28 06:43:48', 'no'),
  (75, 15, '2020-02-28 09:26:49', 'no'),
  (76, 15, '2020-02-29 07:58:51', 'no'),
  (77, 17, '2020-03-06 18:43:42', 'no'),
  (78, 17, '2020-03-06 18:45:24', 'no'),
  (79, 17, '2020-05-27 04:31:13', 'no'),
  (80, 17, '2020-05-27 04:55:36', 'no'),
  (81, 17, '2020-05-30 17:38:10', 'no'),
  (82, 17, '2020-05-30 18:14:34', 'no');
-- --------------------------------------------------------
--
...
--
INSERT INTO `transaction` (`transid`, `fromid`, `toid`, `bid`)
VALUES (53, 15, 17, 65),
  (56, 17, 15, 69),
  (57, 15, 17, 67);
-- --------------------------------------------------------
...
VALUES (
    ...
    'marvin',
    '1234@456.com',
    '$2y$10$QM8fM1twBoGPH0/BEquy4.bSdrxeRH6p6QdA2GJKJMG95qLQ3Rsc2',
    '',
    'upload/15.jpg'
  ),
  (
    ...
    'kaushal',
    'kaushal123',
    'yajuvendrachahal98@gmail.com',
    '$2y$10$y/Ussop3YHU8Du9M/ZkyfulfP/Ou0jPlCJtRELoWuQ/GGcZWLZkTW',
    '',
    'upload/17.jpg'
  );
-- --------------------------------------------------------
...
--
CREATE TABLE `validuserr` (`email` varchar(80) NOT NULL) ENGINE = InnoDB DEFAULT CHARSET = latin1;
--
-- Dumping data for table `validuserr`
--
INSERT INTO `validuserr` (`email`)
VALUES ('kaushalmistry2611@gmail.com'),
